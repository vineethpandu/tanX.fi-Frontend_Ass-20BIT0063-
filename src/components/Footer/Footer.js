        ...
        <footer>
            <div className="footer__container">
                    ...
                    <div className="footer__contact__container">
                        ...
                        <ul className="footer__contacts">
                            <li className="footer__contact">
                                <LocalPhoneIcon /> <span>+91 6300332280</span>
                            </li>
                            <li className="footer__contact">
                                <EmailIcon /> <span>vineethworkspace2024@gmail.com</span>
                            </li>
                            <li className="footer__contact">
                                <LocationOnIcon /> <span>VIT VELLORE, India</span>
                            </li>
                        </ul>
                    </div>
                ...
                <div className="fotter__copyright__container">
                    <ul className='nav'>
                        <li className="footer__copyright">©2024 vineethtbsLtd. |</li>
